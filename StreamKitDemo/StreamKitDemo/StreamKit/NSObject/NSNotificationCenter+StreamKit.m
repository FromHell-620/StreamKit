...
- (NSNotificationCenter*)sK_addEventBlockWithName:(NSNotificationName)aName aObject:(id)anObject block:(id)eventBlock
{
...
{
    return ^ NSNotificationCenter* (NSNotificationName aName,void(^block)(NSNotification* noti)) {
        return [self sK_addEventBlockWithName:aName aObject:nil block:block];
    };
}

- (NSNotificationCenter* (^)(NSNotificationName aName,id anObject,void(^block)(NSNotification* noti)))sk_addNotificationWithObject
{
    return ^ NSNotificationCenter* (NSNotificationName aName,id anObject,void(^block)(NSNotification* noti)) {
        return [self sK_addEventBlockWithName:aName aObject:anObject block:block];
    };
}
...
{
    return ^ NSNotificationCenter* (NSNotificationName aName,void(^block)(NSNotification* noti)) {
        return [[NSNotificationCenter defaultCenter] sK_addEventBlockWithName:aName aObject:nil block:block];
    };
}
...
{
    return ^ NSNotificationCenter* (NSNotificationName aName,id anObject,void(^block)(NSNotification* noti)) {
        return [[NSNotificationCenter defaultCenter] sK_addEventBlockWithName:aName aObject:anObject block:block];
    };
}
